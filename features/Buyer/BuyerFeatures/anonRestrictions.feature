Feature: Check Anonymous users restrictions
  ...
  Scenario: Verify that an anonymus user cannot add to wishlist
    ...
    And I add to wishlist the "TestAutoDeviceProd" product from listing page
...
#     DE MODIFICAT conform Verify that price is not visible for products with "available for sale = NO"
#     din TEST SUITES AND CASES/SMOKE TEST SUITE
#  @javascript @insulated
